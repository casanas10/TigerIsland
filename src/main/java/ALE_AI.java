...
//
//        if (ableToBuildATigerPlayground().buildSuccessfull) return 6;
//
//        else if (findAISettlements5orGreater(aiPlayer) != -1) return 1;  //build a totoro
//
...
//
//            default: return expandSettlement();
//        }
//
//    }
//
...
//
//        int level3Hex = ableToBuildATigerPlayground().hexID;
//
//        MoveData info = new MoveData();
//
//        HashMap<Integer, int[]> allPossibleTiles = getAllPossibleTilePlacementPosition(islandMap.getAllHexesOnMap());
